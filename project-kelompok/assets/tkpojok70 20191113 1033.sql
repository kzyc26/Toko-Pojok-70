...
CREATE TABLE `review` (
  ...
  KEY `FK_Review_1` (`Id_transaction`),
  KEY `FK_Review_2` (`id_product_detail`),
  CONSTRAINT `FK_Review_1` FOREIGN KEY (`Id_transaction`) REFERENCES `transaction` (`id_transaction`),
  CONSTRAINT `FK_Review_2` FOREIGN KEY (`id_product_detail`) REFERENCES `product_detail` (`id_product_detail`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
