...
$cmd_orderhistory="SELECT t.transaction_id as `Transaction ID`, fullname, dd.alamat,dd.kab_kota,dd.kecamatan,dd.kelurahan,dd.provinsi,dd.kode_pos,total_transaction,d.delivery_status
