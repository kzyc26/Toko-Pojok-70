...
where td.transaction_id = t.transaction_id and td.id_product_detail=pd.id_product_detail and p.id_product = pd.id_product and year(t.`date`) = year(CURRENT_DATE) and month(t.`date`) = '".$month."' and year(t.`date`) = '$year'" ;
